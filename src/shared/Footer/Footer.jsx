...
const Footer = () => {
  ...
  <aside>
    ...
    {/* <img src={logoText} className='h-32' alt="" />
    </div> */}
  ...
  <h3 className='Worker text-3xl font-bold'>Wor<span className='text-[#005d45]'>ker</span></h3>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">Mirpur, 10</a> 
